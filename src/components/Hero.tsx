    ...
    <section className="relative min-h-screen overflow-hidden bg-charcoal pt-16">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-64px)] max-w-3xl flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mb-6 text-[13px] uppercase tracking-[0.2em] text-copper">
          For General Contractors &amp; Home Service Businesses
        </p>
        ...
        >
          Stop Renting Leads.
          <br />
          <span className="text-copper">Start Owning Them.</span>
        </h1>

        {/* Subhead */}
        <div className="mt-10 max-w-xl space-y-5 text-[17px] leading-[1.8] text-stone-light">
          <p>
            If you&apos;re a general contractor paying $50–$100 per lead to
            Angi, HomeAdvisor, or Thumbtack... and you don&apos;t even get to
            keep those leads... this might be the most important letter you read
            this year.
          </p>
          <p className="font-medium text-cream">
            Here&apos;s the uncomfortable truth: you&apos;re renting customers
